	...
	<p>Welcome to <b>The Money Company</b> (“Company”, “we”, “our”, “us”)!</p>
	<p>
		These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at <b
			>moneycompany.app</b
		>
		(together or individually “Service”) operated by <b>The Money Company</b>.
	</p>
	<p>
	...
	<p>
		...
		but please let us know by emailing at <b>ashtynmorel@gmail.com</b> so we can try to find a solution.
	...
	<p>
		...
		same conditions unless you cancel it or The Money Company cancels it. You may cancel your
		Subscription renewal either through your online account management page or by contacting
		ashtynmorel@gmail.com customer support team.
	</p>
	<p>
		A valid payment method is required to process the payment for your subscription. You shall
		provide The Money Company with accurate and complete billing information that may include but
		not limited to full name, address, state, postal or zip code, telephone number, and a valid
		payment method information. By submitting such payment information, you automatically authorize
		The Money Company to charge all Subscription fees incurred through your account to any such
		payment instruments.
	</p>
	<p>
		Should automatic billing fail to occur for any reason, The Money Company reserves the right to
		terminate your access to the Service with immediate effect.
	</p>
	<p>6. <b>Free Trial</b></p>
	<p>
		The Money Company may, at its sole discretion, offer a Subscription with a free trial for a
	...
	<p>
		...
		by The Money Company until Free Trial has expired. On the last day of Free Trial period, unless
	...
	<p>
		At any time and without notice, The Money Company reserves the right to (i) modify Terms of
		Service of Free Trial offer, or (ii) cancel such Free Trial offer.
	</p>
	<p>7. <b>Fee Changes</b></p>
	<p>
		The Money Company, in its sole discretion and at any time, may modify Subscription fees for the
		Subscriptions. Any Subscription fee change will become effective at the end of the then-current
		Billing Cycle.
	</p>
	<p>
		The Money Company will provide you with a reasonable prior notice of any change in Subscription
	...
	<p>8. <b>Refunds</b></p>
	<p>
		We issue refunds for Contracts within <b>0 days</b> of the original purchase of the Contract.
	</p>
	<p>9. <b>Content</b></p>
	<p>
	...
	<p>
		The Money Company has the right but not the obligation to monitor and edit all Content provided
		by users.
	</p>
	<p>
		In addition, Content found on or through this Service are the property of The Money Company or
	...
	<p>
		...
		functionality are and will remain the exclusive property of The Money Company and its licensors.
	...
	<p>
		...
		your claim via email to ashtynmorel@gmail.com, with the subject line: “Copyright Infringement”
	...
	<p>You can contact our Copyright Agent via email at ashtynmorel@gmail.com.</p>
	<p>17. <b>Error Reporting and Feedback</b></p>
	<p>
		You may provide us either directly at ashtynmorel@gmail.com or via third party sites and tools
	...
	<p>
		...
		controlled by The Money Company.
	</p>
	<p>
		The Money Company has no control over, and assumes no responsibility for the content, privacy
	...
	<p style="margin-top: 5em; font-size: 0.7em;">
		...
		for <b>moneycompany.app</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on 2025-01-15.
	</p>
